...
\section{Problems}
Generation of the silhouette edge has two subproblems: generation of the edge list and the selection of silhouette edge segments.  Of the two, generation of the edge list is more complex.  
